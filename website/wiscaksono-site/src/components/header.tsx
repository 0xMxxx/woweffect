...
export const Header = forwardRef<HTMLDivElement, HeaderProps>(({ isFullscreen, toggleFullscreen, ...props }, ref) => {
  return (
    ...
    >
      ...
      <p className='mx-auto select-none font-semibold not-sr-only hidden lg:block'>Seth Diary</p>
      <p className='mx-auto select-none font-semibold not-sr-only lg:hidden block'>Seth Diary</p>
